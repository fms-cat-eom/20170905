...
let update = () => {
  if ( frame % frames === 0 ) { xorshift( 38514389071894 ); }
  ...
  cameraPos = [
    3.5 * Math.sin( cameraPhase * Math.PI * 2.0 ),
    0.0,
    3.5 * Math.cos( cameraPhase * Math.PI * 2.0 )
  ];
